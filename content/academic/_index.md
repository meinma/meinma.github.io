...
### Oral at the NeurIPS workshop: "AI Virtual Cells and Instruments: A New Era in Drug Discovery and Development"
My work on "FocusMR: An Attention-based Single-cell Mendelian Randomization Framework to map cellular contexts at candidate genes" was selected for a presentation at the NeurIPS workshop ["AI Virtual Cells and Instruments: A New Era in Drug Discovery and Development"](https://ai4d3.github.io/2025/index.html) in San Diego. I presented how we use single-cell genetics data and leverage multiple instance learning to identify disease-relevant cell states beyond cell type-level to improve disease understanding and enable precise targeting of candidate genes. 
This workshop was the highlight end of the NeurIPS week with fascinating speakers such as Eric Xing, Alex Zhavoronkov, Linda Goodman, and Arvind Ramanathan.
Their talks, ranging from automated labs, virtual cells to drug discovery were truly insightful. As a PhD candidate in computational biology, it was interesting to learn how startups work to develop target candidates and where AI can best contribute to accelerate this process.

![AI4D3 oral](../../assets/media/Nips.JPG)


### Poster Walk Presentation at EORTC-CLTG Meeting
In October 2025, my main PhD project on distinguishing early mycosis fungoides (MF), a rare tumor disease, from benign inflammatory skin disease earned a poster walk presentation at EORTC CLTG in Athens. In this work, we have identified the two genes _LCK_ and _HOMER1_ as diagnostic biomarkers that enable the early detection of MF and consequently allow the proper treatment of these patients. We have achieved a sensitivity and specificity of 91% and 94% in a validation cohort, respectively. Furthermore, we have tested our developed classifier on 7 international multi center cohorts. This work is now being leveraged by Dermagnostix GmbH to build the emerging diagnostic tool **LymphX**. The preprint containing more information about the two markers and the experiments is available [here](https://www.medrxiv.org/content/10.1101/2025.10.18.25338021v1).
...
The residency provides ongoing mentorship and collaboration opportunities, including regular meetings with Theofanis Karaletsos, kicked-off in person in Munich and continuing remotely, to discuss research progress and methodology.


### Patent Granted: "Differential Diagnosis of Mycosis Fungoides, Method and System"
In collaboration with the Eyerich group and my supervisor Natalie Garzorz-Stark, we filed a patent in 2023 for novel diagnostic biomarkers that exhibit differential expression levels in early-stage mycosis fungoides compared to eczema and psoriasis. 
